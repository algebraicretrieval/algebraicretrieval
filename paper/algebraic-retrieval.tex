...
Algebraic Retrieval lets the agent compose that expression at query time: choose scoring directions, eligible records, and per-record weights. It can revise the program after inspecting results, using named inputs instead of reconstructing their SQL joins or Python setup.
